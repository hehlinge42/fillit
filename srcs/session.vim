...
vnoremap <silent>  ::let @a=@" | execute "normal! vgvy" | let res=system("pbcopy", @") | let @"=@a
map  :r !pbpaste
let s:cpo_save=&cpo
set cpo&vim
...
exe 'vert 3resize ' . ((&columns * 180 + 181) / 362)
exe '4resize ' . ((&lines * 26 + 27) / 55)
exe 'vert 4resize ' . ((&columns * 180 + 181) / 362)
argglobal
setlocal autoindent
setlocal backupcopy=
setlocal nobinary
